...
I have split the full data set from 2014 to 2023 into zipped `.csv` files for each year in order to get under the GitHub file size limit. If you plan on using the full set, note that the combined `.csv` file is roughly 400 MB in size.
